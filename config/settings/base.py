...
)  # (toxsign/config/settings/base.py - 3 = toxsign/)
APPS_DIR = ROOT_DIR.path("toxsign")
...
MIGRATION_MODULES = {"sites": "toxsign.contrib.sites.migrations"}
...
ADMINS = [("""Thomas Darde""", "dardethomas@gmail.com")]
# https://docs.djangoproject.com/en/dev/ref/settings/#managers
MANAGERS = ADMINS

# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ["toxsign.taskapp.celery.CeleryAppConfig"]
if USE_TZ:
